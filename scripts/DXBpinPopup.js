//Burj Khalifa
var pin1 = document.getElementById("BurjKhalifa");
var popup1 = document.getElementById("Bjk_Pop");
...
//Burj Al Arab
var pin2 = document.getElementById("BurjAlArab");
var popup2 = document.getElementById("Bja_Pop");
...
//Palm Jumeira
var pin3 = document.getElementById("Palm");
var popup3 = document.getElementById("palm_Pop");
...
//Dubai Spice Souq
var pin4 = document.getElementById("Spice");
var popup4 = document.getElementById("spice_Pop");
...
function showPopupD(evt) {
  ...
  popup4.style.left = (iconPos.right + 40) + "px";
  popup4.style.top = (window.scrollY + iconPos.top - 100) + "px";
